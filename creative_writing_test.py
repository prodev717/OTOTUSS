...
def main():
    ...
    ssdp_model = SSDPModel(model_name=TARGET_MODEL, extract_final_answer=False, seed=43)
    ototuss_model = OtotussModel(model_name=TARGET_MODEL, extract_final_answer=False, seed=43)
